...
HDFView 3.3.2 that was compiled on:
      Windows win-amd64

with:  Java JDK 22.0.1

It was built with the following options:
   -- SHARED HDF 4.3.0
   -- SHARED HDF5 1.14.4.3

===========================================================================
Note: By default HDFView runs on the included Java JRE 22.
===========================================================================
...
The contents of this directory are:
   ...
   HDFView-3.3.2.exe (or .msi)  - HDFView Installer

Running
===========================================================================
To install HDFView for Windows:

1. Execute HDFView-3.3.2.exe (or .msi)
2. Follow prompts
